"""
Llama Model Client for SJSU Virtual Assistant
Provides interface to local or Ollama-hosted Llama models
"""
...
class LlamaClient:
    """Client for Llama models via Ollama"""
    ...
    def __init__(self, model_name: str = "llama3.1", base_url: str = "http://localhost:11434"):
        ...
        print(f"Initialized Llama client with model: {model_name}")
    ...
    def get_model_info(self) -> Dict[str, Any]:
        ...
        """
        try:
            response = requests.get(f"{self.api_url}/show", json={"name": self.model_name})
            response.raise_for_status()
...
def get_available_llama_models() -> List[str]:
    """
    Get list of common Llama models available via Ollama
